...
def parse_args(argv: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        '--theme',
        '-t',
        help="choose color theme " f"(default: {DEFAULT_SETTINGS['theme']})",
    )
    parser.add_argument(
        '--list-themes',
        action="store_true",
    ...
    parser.add_argument(
        ...
        help="force the color depth " f"(default: {DEFAULT_SETTINGS['color-depth']})",
    )
    parser.add_argument(
        '-e',
        '--explore',
...
def _write_zuliprc(
    ...
    try:
        ...
        return f"{ex.__class__.__name__}: " f"zuliprc could not be created at {to_path}"
