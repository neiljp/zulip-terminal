...
class Model:
    ...
    def exception_safe_result(self, future: 'Future[bool]') -> bool:
        try:
    ...
    def fetch_all_topics(self, workers: int) -> None:
        ...
        with ThreadPoolExecutor(max_workers=workers) as executor:
            ...
            thread_objects = {i: executor.submit(
                self.get_topics_in_stream, list_of_streams[i::workers])
                for i in range(workers)}  # type: Dict[int, Future[bool]]
