...
**TODO**
- update screenshots?
- fix trailing date range in contributor graph for actual release date
- update with latest merges

## 0.7.0 - NEXT RELEASE TBD

This release includes contributions from our four 2021
[GSoC](https://summerofcode.withgoogle.com/) students, though as with recent
releases we welcomed those from
[many](https://github.com/zulip/zulip-terminal/graphs/contributors?from=2021-01-29&to=2029-01-28&type=c)
...
- Many type annotations added to tests (eg. #1076, #1077, #1083, #1091, #1096, #1099, #1102, #1105, #1125)
