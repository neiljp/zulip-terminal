...
Expected to be a point release, this contains much of the remaining work from last year's GSoC students, and various other contributors - thanks to you all! (180+ commits)

Waiting for autocomplete, popup notifications, mentions, better themes & search ... this release is for you!
...
- Popup notifications for private messages & mentions (NOTE: disabled by default, as tools must be installed)
...
- Support added for Python 3.8 and PyPy
...
### Important bugfixes
- If changing to a narrow which contains the current message, keep focus on that message
- Message search results reset between searches
