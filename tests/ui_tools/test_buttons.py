...
class TestMessageLinkButton:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            case({'narrow': 'stream:topic', 'topic_name': 'Valid',
                  'stream': {'stream_id': 1, 'stream_name': None}},
                 True,
                 None,
                 ['Valid'],
            ...
            case({'narrow': 'stream:topic', 'topic_name': 'Invalid',
                  'stream': {'stream_id': 1, 'stream_name': None}},
                 True,
                 None,
                 [],
            ...
            case({'narrow': 'stream:near', 'message_id': 1,
                  'stream': {'stream_id': 1, 'stream_name': None}},
                 True,
                 None,
                 None,
            ...
            case({'narrow': 'stream:near', 'message_id': None,
                  'stream': {'stream_id': 1, 'stream_name': None}},
                 True,
                 None,
                 None,
            ...
            case({'narrow': 'stream:topic:near', 'topic_name': 'Valid',
                  'message_id': 1,
                  'stream': {'stream_id': 1, 'stream_name': None}},
                 True,
                 None,
