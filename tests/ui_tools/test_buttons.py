...
class TestMessageLinkButton:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            case(
                "11-user2",
                dict(type=None, recipient_ids=[11], recipient_emails=None),
                id="pm_exposed_format_1_ambiguous",
            ),
            case(
                "5-bot-name",
            ...
            case(
                "5-bot;name",
                dict(type=None, recipient_ids=[5], recipient_emails=None),
                id="pm_with_bot_exposed_format_1_ambiguous",
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            case(
                "/#narrow/pm-with/1001,12-pm/near/1",
                ParsedNarrowLink(
                    narrow="pm-with:near",
                    message_id=1,
                    pm_with=DecodedPM(
