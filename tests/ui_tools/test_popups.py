...
class TestUserInfoView:
    ...
    @pytest.mark.parametrize(
        ...
        [
            case({}, "Email", "person2@example.com", id="user_email"),
            case({"email": ""}, "Email", None, id="user_empty_email"),
            case(
            ...
            case({}, "Date joined", None, id="user_empty_date_joined"),
            case(
            ...
            case(
                ...
                "Role",
                "Generic Bot",
                id="user_is_generic_bot",
            ),
            case(
                {"is_bot": True, "bot_type": 2},
                "Role",
                "Incoming Webhook Bot",
                id="user_is_incoming_webhook_bot",
            ),
            case(
                {"is_bot": True, "bot_type": 3},
                "Role",
                "Outgoing Webhook Bot",
                id="user_is_outgoing_webhook_bot",
            ),
            case(
