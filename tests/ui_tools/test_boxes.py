...
class TestWriteBox:
    ...
    @pytest.mark.parametrize(["initial_focus_name",
        ...
        case('CONTAINER_HEADER', 'HEADER_BOX_STREAM', "stream", True, False,
             'CONTAINER_HEADER', 'HEADER_BOX_TOPIC', id='stream_name_to_topic_box'),
        case('CONTAINER_HEADER', 'HEADER_BOX_TOPIC', "stream", True, False,
             'CONTAINER_MESSAGE', 'MESSAGE_BOX_BODY', id='topic_to_message_box'),
        case('CONTAINER_HEADER', 'HEADER_BOX_TOPIC', "stream", False, True,
             'CONTAINER_HEADER', 'HEADER_BOX_EDIT',
             id='topic_edit_only-topic_to_edit_mode_box'),
        case('CONTAINER_HEADER', 'HEADER_BOX_EDIT', "stream", False, True,
             'CONTAINER_HEADER', 'HEADER_BOX_TOPIC',
             id='topic_edit_only-edit_mode_to_topic_box'),
        case('CONTAINER_MESSAGE', 'MESSAGE_BOX_BODY', "stream", True, False,
             'CONTAINER_HEADER', 'HEADER_BOX_STREAM', id='message_to_stream_name_box'),
        case('CONTAINER_HEADER', 'HEADER_BOX_STREAM', "stream", True, True,
             'CONTAINER_HEADER', 'HEADER_BOX_TOPIC',
             id='edit_box-stream_name_to_topic_box'),
        case('CONTAINER_HEADER', 'HEADER_BOX_TOPIC', "stream", True, True,
             'CONTAINER_HEADER', 'HEADER_BOX_EDIT',
             id='edit_box-topic_to_edit_mode_box'),
        case('CONTAINER_HEADER', 'HEADER_BOX_EDIT', "stream", True, True,
             'CONTAINER_MESSAGE', 'MESSAGE_BOX_BODY',
             id='edit_box-edit_mode_to_message_box'),
        case('CONTAINER_MESSAGE', 'MESSAGE_BOX_BODY', "stream", True, True,
             'CONTAINER_HEADER', 'HEADER_BOX_STREAM',
             id='edit_box-message_to_stream_name_box'),
        case('CONTAINER_HEADER', 'HEADER_BOX_RECIPIENT', "private", True, False,
             'CONTAINER_MESSAGE', 'MESSAGE_BOX_BODY', id='recipient_to_message_box'),
        case('CONTAINER_MESSAGE', 'MESSAGE_BOX_BODY', "private", True, False,
             'CONTAINER_HEADER', 'HEADER_BOX_RECIPIENT', id='message_to_recipient_box'),
    ])
