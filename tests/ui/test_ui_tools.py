...
class TestMessageBox:
    ...
    @pytest.mark.parametrize('content, expected_markup', [
        case('', [], id='empty'),
        case('<p>hi</p>', ['', 'hi'], id='p'),
        case('<span class="user-mention">@Bob Smith',
             [('msg_mention', '@Bob Smith')], id='user-mention'),
        case('<span class="user-group-mention">@A Group',
             [('msg_mention', '@A Group')], id='group-mention'),
        case('<code>some code', [('msg_code', 'some code')], id='code'),
        case('<div class="codehilite">some code', [('msg_code', 'some code')],
             id='codehilite'),
        ...
        # FIXME Unsupported:
        case('<div class="message_embed">',
             ['[EMBEDDED CONTENT NOT RENDERED]'], id='embedded_content'),
        # TODO: Generate test cases to work with both soup2markup and
        # footlinks_view.
        case('<a href="http://foo">Foo</a><a href="https://bar.org">Bar</a>',
             [('msg_link', 'Foo'), ' ', ('msg_link_index', '[1]'),
              ('msg_link', 'Bar'), ' ', ('msg_link_index', '[2]')], id='link_two'),
        case('<a href="http://foo">Foo</a><a href="http://foo">Another foo</a>',
             [('msg_link', 'Foo'), ' ', ('msg_link_index', '[1]'),
        ...
        case('<li>Something<li>else',
             ['\n', '  \N{BULLET} ', '', 'Something',
              '\n', '  \N{BULLET} ', '', 'else'], id='two_li'),
        case('<li>\n<p>Something</p>\n</li><li>else',
             ['\n', '  \N{BULLET} ', '', '', '', 'Something', '',
              '\n', '  \N{BULLET} ', '', 'else'], id='two_li_with_li_p_newlines'),
        case('<ul><li>Something<ul><li>nested',
             ['', '  \N{BULLET} ', '', 'Something',
              '', '\n', '    \N{RING OPERATOR} ', '', 'nested'], id='li_nested'),
        case('<ul><li>Something<ul><li>nested<ul><li>a<ul><li>lot',
             ['', '  \N{BULLET} ', '', 'Something',
              '', '\n', '    \N{RING OPERATOR} ', '', 'nested',
              '', '\n', '      \N{HYPHEN} ', '', 'a',
              '', '\n', '        \N{BULLET} ', '', 'lot', ], id='li_heavily_nested'),
        case('<br>', [], id='br'),
        case('<br/>', [], id='br2'),
        ...
        case('<table><thead><tr><th>Firstname</th><th>Lastname</th></tr></thead>'
        ...
        case('<table><thead><tr><th align="left">Name</th><th align="right">Id'
        ...
        case('<table><thead><tr><th align="center">Name</th><th align="right">Id'
        ...
        case('<table><thead><tr><th>Name</th></tr></thead><tbody><tr><td>Foo</td>'
        ...
        case('<table><thead><tr><th>Column1</th></tr></thead><tbody><tr><td></td>'
             '</tr></tbody></table>', [
                 '┌─', '───────', '─┐\n',
                 '│ ', ('table_head', 'Column1'), ' │\n',
                 '├─', '───────', '─┤\n',
        ...
        case('<time datetime="2020-08-07T04:30:00Z"> Fri, Aug 7 2020, 10:00AM IST'
             '</time>', [(
                 'msg_time', f" {TIME_MENTION_MARKER} Fri, Aug 7 2020, 10:00 (IST) "
             )],
             id='time_human_readable_input'),
        case('<time datetime="2020-08-11T16:32:58Z"> 1597163578</time>', [(
                 'msg_time', f" {TIME_MENTION_MARKER} Tue, Aug 11 2020, 22:02 (IST) "
             )],
             id='time_UNIX_timestamp_input'),
        case('<span class="katex-display">some-math</span>', ['some-math'], id='math'),
        case('<span class="katex">some-math</span>', ['some-math'], id='math2'),
        case('<ul><li>text</li></ul>', ['', '  \N{BULLET} ', '', 'text'], id='ul'),
        case('<ul>\n<li>text</li>\n</ul>',
             ['', '', '  \N{BULLET} ', '', 'text', ''], id='ul_with_ul_li_newlines'),
        case('<ol><li>text</li></ol>', ['', '  1. ', '', 'text'], id='ol'),
        case('<ol>\n<li>text</li>\n</ol>',
             ['', '', '  1. ', '', 'text', ''], id='ol_with_ol_li_newlines'),
        case('<ol start="5"><li>text</li></ol>', ['', '  5. ', '', 'text'],
             id='ol_starting_at_5'),
        # FIXME Strikethrough
        case('<del>text</del>', ['', 'text'], id='strikethrough_del'),
        # FIXME inline image?
        case('<div class="message_inline_image">'
             '<a href="x"><img src="x"></a></div>', [], id='inline_image'),
        # FIXME inline ref?
        case('<div class="message_inline_ref">blah</div>', [], id='inline_ref'),
        case('<span class="emoji">:smile:</span>', [('msg_emoji', ':smile:')],
             id='emoji'),
        case('<div class="inline-preview-twitter"',
             ['[TWITTER PREVIEW NOT RENDERED]'], id='preview-twitter'),
        case('<img class="emoji" title="zulip"/>', [('msg_emoji', ':zulip:')],
             id='zulip_extra_emoji'),
        case('<img class="emoji" title="github"/>', [('msg_emoji', ':github:')],
             id='custom_emoji'),
    ])
