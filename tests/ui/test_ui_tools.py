...
class TestMessageBox:
    ...
    @pytest.mark.parametrize('content, expected_markup', [
        ...
        case('<span class="user-group-mention">@A Group',
             [('msg_mention', '@A Group')]),
        case('<code>some code', [('msg_code', 'some code')]),
        case('<div class="codehilite">some code', [('msg_code', 'some code')]),
        case('<strong>Something', [('msg_bold', 'Something')]),
        case('<em>Something', [('msg_bold', 'Something')]),
        case('<blockquote>stuff', [('msg_quote', ['', 'stuff'])]),
        ...
        case('<br>', []),
        case('<br/>', []),
        case('<hr>', ['[RULER NOT RENDERED]']),
        case('<hr/>', ['[RULER NOT RENDERED]']),
        case('<img>', ['[IMAGE NOT RENDERED]']),
        case('<img/>', ['[IMAGE NOT RENDERED]']),
        ...
        case('<span class="katex-display">some-math</span>', ['some-math']),
        case('<span class="katex">some-math</span>', ['some-math']),
        case('<ul><li>text</li></ul>', ['', '  \N{BULLET} ', '', 'text']),
        case('<ul>\n<li>text</li>\n</ul>',
             ['', '', '  \N{BULLET} ', '', 'text', '']),
        case('<ol><li>text</li></ol>', ['', '  1. ', '', 'text']),
        case('<ol>\n<li>text</li>\n</ol>',
             ['', '', '  1. ', '', 'text', '']),
        case('<ol start="5"><li>text</li></ol>', ['', '  5. ', '', 'text']),
        case('<del>text</del>', ['', 'text']),  # FIXME Strikethrough
        case('<div class="message_inline_image">'
             '<a href="x"><img src="x"></a></div>', []),
        case('<div class="message_inline_ref">blah</div>', []),
